! function($) {
    var Pages = function() {
        ...
        this.$body = $("body"), 
        this.setUserOS(), this.setUserAgent()
    };
                ...
                if (hMenu.children("ul").children("li.more").remove(), hMenu.children("ul").children("li").each(function(index) {
                    ...
                    if ((possibleLi -= extraLiHide) < liCount)
                        for (var wrapper = function(hMenu) {
                            ...
                            }(hMenu), i = possibleLi; i < liCount; i++) {
...
!function(window) {
    ...
    SelectFx.prototype.options = {
        ...
        this.selPlaceholder.addEventListener("click", function() {
            ...
            self._isOpen() && target !== self.selEl && ! function(e, p) {
                if (!e) return !1;
                for (var el = e.target || e.srcElement || e || !1; el && el != p;) el = el.parentNode || !1;
                return !1 !== el
            }(target, self.selEl) && self._toggleSelect()
        ...
        if (this._isOpen()) {
            ...
            var offsetselEl = {
                left: (el = this.selEl).getBoundingClientRect().left + window.pageXOffset - el.ownerDocument.documentElement.clientLeft,
...
function($) {
    ...
    var Notification = function(container, options) {
        ...
        } : (self.options.style, new SimpleNotification), self.notification.append(self.alert), alignWrapperToContainer(), $(window).on("resize", alignWrapperToContainer), self.alert.on("closed.bs.alert", function() {
...
function($) {
    ...
    var Card = function(element, options) {
        this.$element = $(element), this.options = $.extend(!0, {}, $.fn.card.defaults, options), this.$loader = null, this.$body = this.$element.find(".card-body")
    };
    Card.VERSION = "1.0.0", Card.prototype.collapse = function() {
        ...
        if (this.$element.hasClass("card-maximized")) this.$element.removeClass("card-maximized"), this.$element.attr("style", ""), icon.removeClass("pg-fullscreen_restore").addClass("pg-fullscreen"), $.isFunction(this.options.onRestore) && this.options.onRestore(this);
            ...
            this.$element.addClass("card-maximized"), this.$element.css("left", left), this.$element.css("top", headerHeight), icon.removeClass("pg-fullscreen").addClass("pg-fullscreen_restore"), $.isFunction(this.options.onMaximize) && this.options.onMaximize(this)
        }
    ...
    console.log(this);
        if (this.$element = $(element), this.$body = $("body"), this.options = $.extend(!0, {}, $.fn.sidebar.defaults, options), this.bezierEasing = [.05, .74, .27, .99], this.cssAnimation = !0, this.css3d = !0, this.sideBarWidth = 280, this.sideBarWidthCondensed = 210, this.$sidebarMenu = this.$element.find(".sidebar-menu > ul"), this.$pageContainer = $(this.options.pageContainer), this.$sidebarMenu.length) {
            ...
            this.$element.bind("mouseenter mouseleave", function(e) {
                ...
                _this.$body.hasClass("menu-pin") || ($(".sidebar-overlay-slide").hasClass("show") && ($(".sidebar-overlay-slide").removeClass("show"), $("[data-pages-toggle']").removeClass("active")), _this.$element.css({
