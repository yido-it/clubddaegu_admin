...
! function(n) {
    ...
    function Zt(t) {
        return P("<div/>", {
            ...
            role: "status"
        }).html(t.oLanguage.sProcessing).append("<span>Loading...</span>").insertBefore(t.nTable)[0]
    }
    ...
    var Ie = [],
        ...
        He = (e("columns()", function(n, a) {
            ...
            buttons: {},
            classes: {},
            build: "dt/dt-1.13.4/fc-4.2.2/sl-1.6.2",
            errMode: "alert",
            feature: [],
            search: [],
            selector: {
...
! function(e) {
    ...
    }) : "object" == typeof exports ? (i = require("jquery"), l = function(t, s) {
        s.fn.dataTable || require("datatables.net")(t, s)
    }, "undefined" != typeof window ? module.exports = function(t, s) {
        return t = t || window, s = s || i(t), l(t, s), e(s, 0, t.document)
    } : (l(window, i), module.exports = e(i, window, window.document))) : e(jQuery, window, document)
}(function(l, t, s, F) {
    "use strict";
    var A, i, e, o, r = l.fn.dataTable;

    function d(t, s) {
        var e = this;
        if (i && i.versionCheck && i.versionCheck("1.10.0")) return t = new i.Api(t), this.classes = A.extend(!0, {}, d.classes), this.c = A.extend(!0, {}, d.defaults, s), s && s.left !== F || this.c.leftColumns === F || (this.c.left = this.c.leftColumns), s && s.right !== F || this.c.rightColumns === F || (this.c.right = this.c.rightColumns), this.s = {
            barWidth: 0,
            dt: t,
    ...
    return d.prototype.left = function(t) {
            ...
            if (0 < c && a.set(c - 1, n), f.visible()) {
                ...
                if (c - n < this.c.left) {
                    if (A(this.s.dt.table().node()).addClass(this.classes.tableFixedLeft), t.addClass(this.classes.tableFixedLeft), 0 < c - n)
                        for (var C = c; C + 1 < o;) {
                            if ((y = this.s.dt.column(C - 1, {
                                    page: "current"
                                })).visible()) {
                                r += A(y.nodes()[0]).outerWidth(), d += y.header() || y.footer() ? A(y.header()).outerWidth() : 0;
                                break
                            }
                            C--
                        }
                    for (var m = 0, p = h; m < p.length; m++) {
                        var x = p[m];
                        A(A(x).children()[c - n]).css(this._getCellCSS(!1, r, "left")).addClass(this.classes.fixedLeft)
                    }
        ...
        for (var B = 0, S = 0, _ = 0, c = o - 1; 0 <= c; c--)
            if ((f = this.s.dt.column(c)).visible()) {
                ...
                if (k === F && (k = n), c + _ >= o - this.c.right) {
                    if (A(this.s.dt.table().node()).addClass(this.classes.tableFixedRight), t.addClass(this.classes.tableFixedRight), c + 1 + _ < o)
                        for (var y, C = c; C + 1 < o;) {
                            if ((y = this.s.dt.column(C + 1, {
                                    page: "current"
                                })).visible()) {
                                B += A(y.nodes()[0]).outerWidth(), S += y.header() || y.footer() ? A(y.header()).outerWidth() : 0;
                                break
                            }
                            C++
                        }
                    for (var w = 0, T = h; w < T.length; w++) {
                        x = T[w];
                        A(A(x).children()[c - k]).css(this._getCellCSS(!1, B, "right")).addClass(this.classes.fixedRight)
                    }
                    u.css(this._getCellCSS(!0, S, "right")).addClass(this.classes.fixedRight), g.css(this._getCellCSS(!0, S, "right")).addClass(this.classes.fixedRight)
                } else {
                    for (var L = 0, W = h; L < W.length; L++) {
                        var R, x = W[L];
                        (R = A(A(x).children()[c - k])).hasClass(this.classes.fixedRight) && R.css(this._clearCellCSS("right")).removeClass(this.classes.fixedRight)
                    }
        ...
        left: 1,
        right: 0
    }, e = d, i = (A = l).fn.dataTable, l.fn.dataTable.FixedColumns = e, l.fn.DataTable.FixedColumns = e, (o = r.Api.register)("fixedColumns()", function() {
        return this
